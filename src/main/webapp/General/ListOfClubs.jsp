...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/feed.css"/>
    <div class="col-md-8">
        ...
        <form method="post" action="<%=request.getContextPath()%>/ServletLogOut">
            <img style="width: 35px; height: 35px; border: 1px solid transparent; border-radius: 8px;" src="<%=request.getContextPath()%>/resources/img/logout.png"> <input  class="btn btn-primary" type="submit" value="logOut">
        </form>
        ...
        <div class="title-block">
            <img style="width: 35px; height: 35px; border: 1px solid transparent; border-radius: 8px;" src="<%=request.getContextPath()%>/resources/img/clubs.png">Clubs
        </div>
